  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <li v-for="(tradeMark, index) in SearchInfoList.trademarkList" :key="tradeMark.tmid" @click='tradeMarkHandler(tradeMark)'>
            {{tradeMark.tmName}}
          </li>
    ...
    <div class="type-wrap" v-for="(attr, index0) in SearchInfoList.attrsList" :key="index0">
      <div class="fl key">{{attr.attrName}}</div>
      <div class="fl value">
        <ul class="type-list">
          <li v-for="(attrValue, index1) in attr.attrValueList" :key="index1" @click="attrInfoHandler(attr.attrId, attr.attrName, attrValue)">
            <a>{{attrValue}}</a>
          </li>
        </ul>
      </div>
  ...
  export default {
    ...
    methods: {
      tradeMarkHandler(tradeMark) {
        this.$emit('traderMarkInfo', tradeMark)
      },
