<template>
  ...
  <div class="outer">
    ...
    <section class="con">
      ...
      <div class="conPoin">
        <div class="conPoin">
          <a href="###" v-if="categoryView">{{ categoryView.category1Name }}</a>
          <a href="###" v-if="categoryView">{{ categoryView.category2Name }}</a>
          <a href="###" v-if="categoryView">{{ categoryView.category3Name }}</a>
        </div>
      </div>
      <!-- 主要内容区域 -->
      <div class="mainCon">
