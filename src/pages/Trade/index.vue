<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail" v-for="detailInfo in detailArrayList" :key="detailInfo.skuId">
        <h5>商品清单</h5>
        <ul class="list clearFix">
          <li>
            <img style="width: 100px;height: 100px;margin-left: 50px" :src="detailInfo.imgUrl" alt="">
          </li>
          <li>
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>¥{{total}}</span></div>
    ...
    <div class="sub clearFix">
      <router-link class="subBtn" @click="goPay" to="/pay">提交订单</router-link>
    </div>
  </div>
</template>
