<template>
  <div class="cart">
    ...
    <div class="cart-main">
      ...
      <div class="cart-body">
        <ul class="cart-list"
            v-for="cartInfo in cartList" :key="cartInfo.skuId">
          <li class="cart-list-con1">
            <input type="checkbox"
                   @click="changeIsChecked(cartInfo.skuId)"
                   :checked="cartInfo.isChecked===1" name="chk_list">
          </li>
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" @change="skuNumHandler('change', cartInfo, $event.target.value * 1)"
          ...
          <li class="cart-list-con7">
            <a href="#none" @click="deleteCarInfo(cartInfo.skuId)" class="sindelet">删除</a>
            <br>
            <a href="#none">移到收藏</a>
          </li>
        </ul>
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" :checked="isAllChecked" @click="changeAllCheckedCar" type="checkbox">
        <span>全选</span>
      </div>
      <div class="option">
...
import {reqDeleteCarList} from "@/api";
